...
if (!browser.versions.mobile) {//判断是否是移动设备打开
    ...
    **/
    ...
    //针对一言作者超出padding
    if (document.getElementsByClassName("mdui-typo mdui-shadow-3")[0]) {
        document.getElementsByClassName("mdui-typo mdui-shadow-3")[0].style.paddingBottom = document.getElementById("hitokoto_text2").offsetHeight + "px";
    }
    //手机端关闭字幕(延迟性)
